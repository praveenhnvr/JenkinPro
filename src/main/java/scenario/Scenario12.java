...
public class Scenario12
{
   @Test
    public void test12() throws InterruptedException
    {
		...
		driver.findElement(By.xpath("//div[@class='wh-submenu single-column-submenu width-auto']/descendant::span[@class='prcs-d'][2]")).click();
		WebElement ele5V = driver.findElement(By.xpath("//div[@class='filtered-data']/descendant::span[@class='filterDisplayName']"));
		Assert.assertEquals(ele5V.getText(),"Flat 10% Off");
		System.out.println("Products displayed with Flat 10% Off");	
		driver.close();
    }
}
