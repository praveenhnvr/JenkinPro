...
public class Scenario13
{
   @Test
    public void test13() throws InterruptedException
    {
		...
		WebElement ele5 = driver.findElement(By.xpath("//div[@class='wh-submenu single-column-submenu width-auto']/descendant::span[@class='prcs-d'][3]"));
		ele5.click();
		...
		Assert.assertEquals(ele5V.getText(),"Flat 15% Off");
		System.out.println("Products displayed with Flat 15% Off");	
		driver.close();
    }
}
